...
struct cfg {
	...
	{ 'E', "ld.datesortdir",      CT_INT, CM_FLIP, "1",      {NULL}, __("Toggle sort by exif date of directories") },
	...
	{ 0,   "gl.txt_bgcolor",      CT_COL, CM_SET,  "0.8 0.8 0.8 0.7", {NULL}, __("Text background color") },
	{ 0,   "gl.txt_fgcolor",      CT_COL, CM_SET,  "0.0 0.0 0.0 1.0", {NULL}, __("Text foreground color") },
