...
struct cfg {
	...
	{ 0,   "gl.col_dirname",      CT_COL, CM_SET,  "1.0 1.0 1.0 1.0", {NULL}, __("Text foreground color") },
	{ 0,   "gl.col_playicon",     CT_COL, CM_SET,  "0.0 0.0 0.0 0.7", {NULL}, __("Text foreground color") },
