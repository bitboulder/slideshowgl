...
struct cfg {
	...
	{ 0,   "ld.maxtexsize",       CT_INT, CM_SET,  "1024",   {NULL}, __("Maximal texture size") },
	{ 0,   "ld.maxpanotexsize",   CT_INT, CM_SET,  "4096",   {NULL}, __("Maximal texture size for panoramas") },
	{ 0,   "ld.maxpanopixels",    CT_INT, CM_SET,  "200",    {NULL}, __("Maximal megapixels for panoramas (bigger ones are scaled down)") },
	{ 0,   "ld.maxpanolowdim",    CT_INT, CM_SET,  "2000",   {NULL}, __("Maximal panorama low dimension threshold (do not scale below)") },
